	...
	public static void main(String[] args) {
		...
		try {
			...
			if(extension.equalsIgnoreCase("mzid") || extension.equalsIgnoreCase("mzidentml") || extension.equalsIgnoreCase("mztab")) {
				String newfile = convert(filename);
				System.out.println("FileConverter successfully converted your input file. The converted file in PoGo format has been written to:" + newfile);
			} else {
				System.out.println("The specified file is not a *.mzId, *.mzIdentML, or *.mzTab file.");
			}
			
		} catch (ArrayIndexOutOfBoundsException e) {
			System.out.println("Please specify the file you would like to convert");
		} catch (IOException e) {
			System.out.println("An error occured during conversion. Please ensure that enough memory is available for the output file and the directory of the inpur file is writable.");
		}
	}
